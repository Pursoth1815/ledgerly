...
class UpiAppsHelper {
  ...
  static UpiAppsHelper amazonPay = UpiAppsHelper._fromEnum(_AllUpiApps.amazonPay);
  ...
  static UpiAppsHelper barodaPay = UpiAppsHelper._fromEnum(_AllUpiApps.barodaPay);
  ...
  static UpiAppsHelper equitasUpi = UpiAppsHelper._fromEnum(_AllUpiApps.equitasUpi);
  ...
  static UpiAppsHelper freecharge = UpiAppsHelper._fromEnum(_AllUpiApps.freecharge);

  /// Google Pay(GoogleLLC): com.google.android.apps.nbu.paisa.user
  static UpiAppsHelper googlePay = UpiAppsHelper._fromEnum(_AllUpiApps.googlePay);

  /// HSBC Simply Pay(HSBC India): com.mgs.hsbcupi
  static UpiAppsHelper hsbcSimplyPay = UpiAppsHelper._fromEnum(_AllUpiApps.hsbcSimplyPay);

  /// iMobile(ICICI Bank Ltd.): com.csam.icici.bank.imobile
  static UpiAppsHelper iMobileICICI = UpiAppsHelper._fromEnum(_AllUpiApps.iMobileICICI);
  ...
  static UpiAppsHelper khaaliJeb = UpiAppsHelper._fromEnum(_AllUpiApps.khaaliJeb);
  ...
  static UpiAppsHelper miPayGlobal = UpiAppsHelper._fromEnum(_AllUpiApps.miPayGlobal);

  /// Mi Pay(Only Xiaomi devices): com.mipay.wallet.in (From Get Apps)
  static UpiAppsHelper miPayXiaomi = UpiAppsHelper._fromEnum(_AllUpiApps.miPayXiaomi);
  ...
  static UpiAppsHelper orientalPay = UpiAppsHelper._fromEnum(_AllUpiApps.orientalPay);
  ...
  static UpiAppsHelper realmePaySa = UpiAppsHelper._fromEnum(_AllUpiApps.realmePaySa);
  ...
  static UpiAppsHelper trueCallerUPI = UpiAppsHelper._fromEnum(_AllUpiApps.trueCallerUpi);

  ///BHIM United UPI Pay(United Bank of India): com.fss.unbipsp
  static UpiAppsHelper unitedUpiPay = UpiAppsHelper._fromEnum(_AllUpiApps.unitedUpiPay);

  /// BHIM VIJAYA UPI App(Vijaya Bank): com.fss.vijayapsp
  static UpiAppsHelper vijayaUpi = UpiAppsHelper._fromEnum(_AllUpiApps.vijayaUpi);
